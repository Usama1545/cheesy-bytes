                                                    ...
                                                    @if ($itemdata->is_cart == 1)
                                                        <div class="item-quantity py-1 px-5">
                                                            ...
                                                            <a class="btn btn-sm fw-500 border-0"
                                                                onclick="showitem('{{ $itemdata->slug }}','{{ URL::to('/show-item') }}',{{ $itemdata->is_price_range ? 1 : 0 }},'{{ URL::to('item-' . $itemdata->slug) }}')">+</a>
                                                        </div>
                                                    @else
                                                        <button
                                                            ...
                                                            onclick="showitem('{{ $itemdata->slug }}','{{ URL::to('/show-item') }}',{{ $itemdata->is_price_range ? 1 : 0 }},'{{ URL::to('item-' . $itemdata->slug) }}')">{{ trans('labels.add') }}
                                                            <i
