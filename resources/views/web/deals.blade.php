...
?>
@section('page_title'){{ trans('labels.deals') }} | {{ $itemData->seo_name }} |@endsection
@section('meta_description')
Craving something cheesy and delicious? Check out our latest deals at {{ $itemData->seo_name }}. Order now and enjoy great value!@endsection
@section('content')
