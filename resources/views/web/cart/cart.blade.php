...
?>
@section('page_title'){{ trans('labels.my_cart') }} | {{ $itemData->seo_name }} |@endsection
@section('content')
                                                    ...
                                                    <div class="tbl_cart_product gap-3">
                                                        ...
                                                        <div class="tbl_cart_product_caption">
                                                            ...
                                                            @if ($cartitems->addons_id != '' || $cartitems->extras_id != '')
                                                                @if ($cartitems->addons_name || $cartitems->extras_name)
                                                                    @php
                                                                        $addons = $cartitems->addons_name ? explode('| ', $cartitems->addons_name) : [];
                                                                        $extras = $cartitems->extras_name ? explode('| ', $cartitems->extras_name) : [];

                                                                        $allItems = array_merge($addons, $extras);
                                                                    @endphp

                                                                    @if(count($allItems))
                                                                        <div class="fs-7 text-muted" style="word-break: break-word;">
                                                                            {{ implode(', ', $allItems) }}
                                                                        </div>
                                                                    @endif
                                                                @endif
