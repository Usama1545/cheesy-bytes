...
?>
@section('page_title')
    | {{ trans('labels.menu') }} | {{ @$categorydata->category_name }} | {{ $itemData->name }}
@endsection
@section('content')
        ...
        <section class="menu-section">
            ...
            <div class="container">
                ...
                <div class=" justify-content-between align-items-center w-100">
                    ...
                    <div class="mx-0 d-flex gap-2 mx-md-3">
                        @if (strtolower(@$categorydata->category_name) == strtolower('Pizza') &&
                                !request()->is('houston-missionbend*') &&
                                !request()->is('houston-richmond*'))
                            <button
                                class="btn btn-sm btn-secondary fw-500 px-4 rounded-3 d-flex my-2 justify-content-center align-items-center"
                                data-bs-toggle="modal" data-bs-target="#customPizzaModal" data-bs-size="medium"
                            ...
                            <button
                                class="btn btn-sm btn-secondary fw-500 px-4 rounded-3 d-flex my-2 justify-content-center align-items-center"
                                data-bs-toggle="modal" data-bs-target="#customPizzaModal" data-bs-size="large"
                                style="min-width: 120px;">
                                    ...
                                    <div class="col-12 col-lg-3 col-md-4 col-sm-12">
                                        <div class="h-100 d-flex flex-column">
                                            <div class="card overflow-hidden h-100 flex-grow-1">
                                                @if (strtolower(@$categorydata->category_name) == strtolower('Pizza'))
                                                    <button data-bs-toggle="modal" data-bs-target="#PizzaModal"
                                                        class="cursor-pointer p-0 b-0 rounded-0 border-0"
                                                ...
                                                <div class="card-body pb-0 border-bottom">
                                                    <h5
                                                        class="item-card-title pb-3 fs-6 d-flex justify-content-between align-items-center">
                                                        @if (strtolower(@$categorydata->category_name) == strtolower('Pizza'))
