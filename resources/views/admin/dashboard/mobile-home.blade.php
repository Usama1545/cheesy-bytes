                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                                ...
                                <select class="form-select form-select-sm w-auto" id="useryear"
                                    data-url="{{ URL::to('/admin/mobile-home') }}">
                    ...
                    <div class="card border-0 box-shadow h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                                ...
                                <select class="form-select form-select-sm  w-auto" id="earningsbranch"
                                    data-url="{{ URL::to('/admin/mobile-home') }}">
            ...
            <div class="row">
                @foreach ($getbranchorders as $branchOrder)
                    ...
                    <div class="col-12 mb-3">
                        <div class="card border-0 box-shadow h-100">
                            <div class="card-body">
                                <h5 class="card-title border-bottom pb-3 mb-3">Today's Orders -
                                    {{ $branchOrder['branch_name'] }}</h5>
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            @if ($orderdata['admin_notes'] != null)
                                                                <a href="javascript:void(0)"
                                                                    class="btn btn-primary btn-sm hov square"
