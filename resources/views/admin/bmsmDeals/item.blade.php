...
@section('content')
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <h3>Buy more save more Deals</h3>
            <a href="bmsmDeals/add" class="btn btn-primary">Add New <i class="fa fa-plus"></i></a>
        </div>
        <div class="row">
            <div class="col-12">
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                @foreach ($deals as $item)
                                    <tr class="row1" data-id="{{ $item->id }}">
                                        ...
                                        <td>{{ $item->bmsm_deal_type === 1 ? 'Product Based' : "Cart Based" }}</td>
                                                                                <td>{{ $item->order }}</td>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap gap-1">
                                                <a class="btn btn-sm btn-info square"
                                                   ...
                                                   href="{{ URL::to('admin/bmsmDeals-' . $item->id) }}"> <i
                                                        class="fa-solid fa-pen-to-square"></i></a>
                                                <a class="btn btn-sm btn-danger square"
                                                   tooltip="{{ trans('labels.delete') }}"
                                                   onclick="Delete('{{ $item->id }}','{{ URL::to('admin/bmsmDeals/delete') }}')">
