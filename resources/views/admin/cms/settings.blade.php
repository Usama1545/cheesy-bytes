                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               placeholder="{{ trans('labels.og_title') }}"
                                                               name="og_title"
                                                               id="og_title"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="og_description"
                                                                  placeholder="{{ trans('labels.og_description') }}"
                                                                  id="og_description"
                                                                  rows="6">{{ @$getsettings->og_description == '' ? old('og_description') : @$getsettings->og_description }}</textarea>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   class="form-control" name="order_prefix"
                                                                   id="order_prefix"
                                                                   required>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card border-0 box-shadow">
                                        ...
                                        <div class="card-body">
                                            @foreach(helper::get_branchs() as $branch)
                                                ...
                                                <form action="{{ URL::to('admin/settings/update/footer') }}" method="post"
                                                      enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="text" class="form-control" name="branch_id" hidden value="{{ $branch->id }}">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label class="col-form-label"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="description"
                                                                          placeholder="{{ trans('labels.footer_description') }}"
                                                                          id="footer_description" rows="5"
                                                                          required>{{ @$footerSetting->description == '' ? old('description') : @$footerSetting->description }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        <div class="col-md-6">
