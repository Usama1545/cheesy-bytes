...
@section('content')
    ...
    @endif-->
                        ...
                        <a href="#business_settings" data-tab="business_settings"
                          ...
                          <a href="#first_order_discount" data-tab="first_order_discount"
                            class="list-group-item basicinfo p-3 list-item-secondary d-flex justify-content-between align-items-center"
                            aria-current="true">First Order Setting
                            <i class="fa-regular fa-angle-{{ session()->get('direction') == '2' ? 'left' : 'right' }}"></i>
                        </a>
                        <a href="#credit_settings" data-tab="credit_settings"
                            class="list-group-item basicinfo p-3 list-item-secondary d-flex justify-content-between align-items-center"
                            aria-current="true">Credit Settings
                            <i class="fa-regular fa-angle-{{ session()->get('direction') == '2' ? 'left' : 'right' }}"></i>
                        </a>
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-primary"
                                                        @if (env('Environment') == 'sendbox') type="button"
                                                            onclick="myFunction()" @else type="submit"
                                                            name="contact_update"
                                                            value="1" @endif>{{ trans('labels.save') }}</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
@else
    type="submit" name="contact_update" value="1"
    @endif>{{ trans('labels.save') }}</button>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                    </form>-->
                    <!--                </div>-->
                                        ...
                                        <form action="{{ URL::to('admin/settings/update') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div
                                                    ...
                                                    <button class="btn btn-primary"
                                                        @if (env('Environment') == 'sendbox') type="button"
                                                            onclick="myFunction()" @else type="submit" name="seo_update"
                                                            value="1" @endif>{{ trans('labels.save') }}</button>
                                                </div>
                                            </div>
                                        </form>
    ...
    type="button" onclick="myFunction()"
@else
    type="submit" name="notification_update" value="1"
    @endif>{{ trans('labels.save') }}</button>-->
                        <!--                            </div>-->
                        <!--                        </div>-->
                        <!--                    </form>-->
                                    ...
                                    <div class="card-body">
                                        <form action="{{ URL::to('admin/settings/update') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="col-form-label" for="">Minimum Price for Discount
                                                            <span class="text-danger">*</span></label>
                                                        <input type="number" step=".1" class="form-control"
                                                            name="first_order_min_amount" id="first_order_min_amount" min="0"
                                                            value="{{ @$getsettings->first_order_min_amount == '' ? old('first_order_min_amount') : @$getsettings->first_order_min_amount }}"
                                                            placeholder="Minimum Price for Discount" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="col-form-label" for="">Discount Amount in usd
                                                            <span class="text-danger">*</span></label>
                                                        <input type="number" step=".1" class="form-control"
                                                            name="first_order_discount" id="first_order_discount" min="0"
                                                            value="{{ @$getsettings->first_order_discount == '' ? old('first_order_discount') : @$getsettings->first_order_discount }}"
                                                            placeholder="Discount Amount in usd" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ URL::to('admin/settings/update') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="col-form-label" for="">1 Point Per Dollars
                                                            <span class="text-danger">*</span></label>
                                                        <input type="number" step=".1" class="form-control"
                                                            name="point_per_dollar" id="point_per_dollar" min="0"
                                                            value="{{ @$getsettings->point_per_dollar == '' ? old('point_per_dollar') : @$getsettings->point_per_dollar }}"
                                                            placeholder="1 Point Per Dollars" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="col-form-label" for="">Dollars Per Point
                                                            <span class="text-danger">*</span></label>
                                                        <input type="number" step=".1" class="form-control"
                                                            name="dollar_per_point" id="dollar_per_point" min="0"
                                                            value="{{ @$getsettings->dollar_per_point == '' ? old('dollar_per_point') : @$getsettings->dollar_per_point }}"
                                                            placeholder="Dollars Per Point" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="col-form-label" for="">Minimum Redeem Points
                                                            <span class="text-danger">*</span></label>
                                                        <input type="number" step=".1" class="form-control"
                                                            name="min_redeem_points" id="min_redeem_points"
                                                            min="0"
                                                            value="{{ @$getsettings->min_redeem_points == '' ? old('min_redeem_points') : @$getsettings->min_redeem_points }}"
                                                            placeholder="Minimum Redeem Points" required>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <p
                                                                            class="input-group-text {{ session()->get('direction') == '2' ? 'rounded-start rounded-0' : 'rounded-end' }}">
                                                                            {!! $sociallink->icon !!}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="card border-0 box-shadow">
                                    ...
                                    <div class="card-body">
                                        @foreach (helper::get_branchs() as $branch)
                                            <?php $footerSetting = helper::getFooter($branch->id); ?>
                                            <div class="card mt-2">
                                                <div class="card-header p-3 bg-secondary">
                                                    <h5 class="text-white">
                                                        {{ $branch->name }}
                                                ...
                                                <div class="card-body">
                                                    <form action="{{ URL::to('admin/settings/update/footer') }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    name="title" id="footer_title"
                                                                    value="{{ @$footerSetting->title == '' ? old('title') : $footerSetting->title }}"
                                                                    required>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label class="col-form-label"
                                                                        ...
                                                                        <span class="text-danger">*</span></label>
                                                                    <textarea class="form-control" name="description" placeholder="{{ trans('labels.footer_description') }}"
                                                                        id="footer_description" rows="5" required>{{ @$footerSetting->description == '' ? old('description') : @$footerSetting->description }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            id="number"
                                                                            value="{{ @$footerSetting->number == '' ? old('number') : $footerSetting->number }}"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            id="email"
                                                                            value="{{ @$footerSetting->email == '' ? old('email') : $footerSetting->email }}"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            id="address"
                                                                            value="{{ @$footerSetting->address == '' ? old('address') : $footerSetting->address }}"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                            </div>
    ...
    type="button" onclick="myFunction()"
@else
    type="submit" name="mobileapp_update" value="1"
    @endif>{{ trans('labels.save') }}</button>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                    </form>-->
    ...
    type="button" onclick="myFunction()"
@else
    type="submit" name="admin_update" value="1"
    @endif>{{ trans('labels.save') }}</button>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                    </form>-->
    ...
    type="button" onclick="myFunction()"
@else
    type="submit" name="other_update" value="1"
    @endif>{{ trans('labels.save') }}</button>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                    </form>-->
