        ...
        <div class="resept">
            ...
            <div class="total-billes-amount" style="text-align: center">
                ...
                <p
                    ...
                    <small class="fw-500 text-uppercase fs-10 text-center text-dark">{{ $orderdata->created_at }}
                    </small>
                </p>
            </div>
            <div class="total-billes-amount" style="text-align: center">
                                ...
                                <h6 class="m-0 fw-500 product-text-size">
                                        ...
                                        <ul class="m-0 p-0" id="item-extras">
                                            ...
                                            @foreach ($dippingNames as $key => $name)
                                                <li class="list-group-item  d-flex  text-muted">
                                                    ...
                                                    <small class=" px-3">{{ $dippingQuantities[$key] }} </small>
                                                    <small
                                    ...
                                    @if ($orders->custom_pizza_id != null)
                                        ...
                                        <div class="mt-2 border-bottom" id="extras">
                                            ...
                                            <p class="m-0 ">Crust: <small
                                                    class="text-muted">{{ $data->crust?->name }}</small>
                                            </p>
                                            ...
                                            <ul class="m-0 p-0" id="item-extras">
                                                @foreach ($data->toppings as $topping)
                                                    <li class="list-group-item  d-flex  text-muted">
                                                        <small class="flex-grow-1 ">{{ $topping->name }}</small>
                                                        <small class="ml-3">{{ $topping->pivot->side }}</small>
                                                        <small class=" px-3">{{ $topping->pivot->quantity }}</small>
                                                    </li>
                                                @endforeach
                                            </ul>
                                            ...
                                            <ul class="m-0 p-0" id="item-extras">
                                                @foreach ($data->dipping as $dipping)
                                                    <li class="list-group-item  d-flex  text-muted">
                                                        <small class="flex-grow-1 ">{{ $dipping->name }}</small>

                                                        <small class=" px-3">{{ $dipping->pivot->quantity }}
                                                        </small>
                                                        <small
                        ...
                        <div class="text-dark">
                            ...
                            @if ($orderdata->delivery_charge != 0)
                                <div class="d-flex justify-content-between text-dark my-1">
                                    ...
                                    <span class="txt-resept-font-size fw-500 text-uppercase text-end"
                                        style="float: right;">
            ...
            <div class="col-12 d-flex justify-content-between underline-3 py-2">
                ...
                <span class="fw-semibold line-1 product-text-size"
                    style="float: right;">{{ helper::currency_format($orderdata->grand_total) }}</span>
            </div>
            <h2 class="my-2 fs-8 fw-600 text-center line-1" style="text-align: center">
                {{ trans('labels.thanks_for_order') }}</h2>
            <div class="col-12 mt-2 d-flex justify-content-center text-center" style="text-align: center">
                <button type='button' id="btnPrint"
                    class="rounded border-0 btn btn-primary text-white text-capitalize fs-8 px-3 py-2"
                    style="color: white">{{ trans('labels.print') }}</button>
            </div>
        </div>
    </div>
    <script>
