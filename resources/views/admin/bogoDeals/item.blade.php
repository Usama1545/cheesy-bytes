...
@section('content')
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <h3>Deals</h3>
            <a href="bogoDeals/add" class="btn btn-primary">Add New <i class="fa fa-plus"></i></a>
        </div>
        <div class="row">
            <div class="col-12">
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap gap-1">
                                                <a class="btn btn-sm btn-info square"
                                                   ...
                                                   href="{{ URL::to('admin/bogoDeals-' . $item->id) }}"> <i
                                                        class="fa-solid fa-pen-to-square"></i></a>
                                                <a class="btn btn-sm btn-danger square"
                                                   tooltip="{{ trans('labels.delete') }}"
                                                   onclick="Delete('{{ $item->id }}','{{ URL::to('admin/bogoDeals/delete') }}')">
