...
//
//        Log::info("Fetch print job request received", ['printer_id' => $printerId, 'mac_id' => $macId]);
//
...
//                "jobname" => "Order Invoice #" . $order->id,
//                "jobdata" => $jobData,
//                "response" => "ack",
//                "deletejob" => true
//            ];
//
//            Log::info("Print job {$printJob->id} prepared for printer ID: $printerId");
//
