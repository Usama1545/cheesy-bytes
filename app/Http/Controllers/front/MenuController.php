...
class MenuController extends Controller
{
         ...
         try {
            ...
            if (!$branch_id) {
                return response()->json([
                    'status' => false,
                    'message' => 'branch_id not found in session'
                ], 400);
            }
            ...
            return response()->json([
                'status' => false,
                'message' => 'Something went wrong while fetching crusts'
            ], 500);
        }
    }
    ...
    public function getToppings()
    {
        ...
        try {
            ...
            return response()->json([
                'status' => false,
                'message' => 'Something went wrong while fetching toopings'
            ], 500);
        }
    }
    ...
    public function getSauces()
    {
        try {
            ...
            $sauces = CustomPizzaSauce::where('branch_id', $branch_id)
                ->get()
                ->map(function ($sauce) {
                    return [
                        'id' => $sauce->id,
            ...
            return response()->json([
                'status' => false,
                'message' => 'Something went wrong while fetching sauces'
            ], 500);
        }
    }
