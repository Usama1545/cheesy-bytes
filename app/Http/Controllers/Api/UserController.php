...
class UserController extends Controller
{
    ...
    public function removeToken(Request $request)
    {
        ...
        UserDeviceToken::where('fcm_token', $request->fcm_token)->delete();
    ...
    public function deleteAccount()
    {
        ...
        $user->tokens()?->delete(); // logout everywhere if using Sanctum
        UserDeviceToken::where('user_id', $user->id)->delete();
        $user->delete(); // soft delete

        return response()->json(['status' => 'user account deleted']);
    }
}
