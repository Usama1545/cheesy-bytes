...
function extras_fields(name, price) {
    ...
    divtest.innerHTML = '' +
        ...
        '<div class="col-md-3">' +
        '<div class="form-group">' +
        '<select name="extras_branch_id[' + branch_row + '][]" class="form-control selectpicker" multiple required data-live-search="true">' +
        options +
        '</select>' +
        '</div>' +
        '</div>' +
...
function more_editextras_fields(name, price) {
    ...
    editdivtest.innerHTML =
        ...
        '<div class="form-group">' +
        '<div class="d-flex gap-2">' +
        '<select name="extras_branch_id[' + extras_row + '][]" class="form-control selectpicker" multiple required data-live-search="true">' + options + '</select>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '<div class="col-md-1">' +
        '<div class="form-group">' +
        '<div class="d-flex gap-2">' +
        '<input type="checkbox" class="form-check-input"  value="1" name="extras_default[]" required>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '<div class="col-md-1">' +
