...
use App\Http\Controllers\admin\BmsmDealController;
use App\Http\Controllers\admin\BogoDealController;
...
Route::group(['prefix' => 'admin', 'namespace' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'AdminAuth'], function () {
        ...
        Route::get('item/export_csv', [ItemController::class, 'export_csv']);
        ...
        Route::get('bogoDeals', [BogoDealController::class, 'index']);
        Route::get('bogoDeals/add', [BogoDealController::class, 'additem']);
        Route::post('bogoDeals/store', [BogoDealController::class, 'store']);
        Route::post('bogoDeals/update', [BogoDealController::class, 'update']);
        Route::get('bogoDeals-{id}', [BogoDealController::class, 'edititem']);
        Route::post('bogoDeals/delete', [BogoDealController::class, 'delete']);

        Route::get('bmsmDeals', [BmsmDealController::class, 'index']);
        Route::get('bmsmDeals/add', [BmsmDealController::class, 'additem']);
        Route::post('bmsmDeals/store', [BmsmDealController::class, 'store']);
        Route::post('bmsmDeals/update', [BmsmDealController::class, 'update']);
        Route::get('bmsmDeals-{id}', [BmsmDealController::class, 'edititem']);
        Route::post('bmsmDeals/delete', [BmsmDealController::class, 'delete']);
        ...
        // branches
        Route::get('deal-notifications', [DealNotificationController::class, 'index'])->name('admin.deal-notifications.index');
        Route::get('deal-notifications/create', [DealNotificationController::class, 'create'])->name('admin.deal-notifications.create');        
        Route::post('deal-notifications/store', [DealNotificationController::class, 'store'])->name('admin.deal-notifications.store');
        Route::post('deal-notifications/status', [DealNotificationController::class, 'status'])->name('admin.deal-notifications.status');
        Route::get('deal-notifications/edit/{id}', [DealNotificationController::class, 'edit'])->name('admin.deal-notifications.edit');
        Route::put('deal-notifications/update/{id}', [DealNotificationController::class, 'update'])->name('admin.deal-notifications.update');
        Route::post('deal-notifications/delete', [DealNotificationController::class, 'destroy'])->name('admin.deal-notifications.destroy');
        ...
        Route::post('branch/isWeb', [BranchController::class, 'isWeb']);
        Route::post('branch/isMobile', [BranchController::class, 'isMobile']);
        ...
        Route::post('settings/update', [SettingController::class, 'settings_update']);
                Route::post('settings/update/footer', [SettingController::class, 'settings_footer']);
...
//    Route::get('/item-{slug}', [WebItemController::class, 'itemdetailsCon'])->name('itemdetails');
});

//  -------------------------------   for admin  -----------------------------------------   //

Route::group(['namespace' => 'front', 'middleware' => ['MaintenanceMiddleware','RedirectLegacyUrls']], function () {
	// home
        ...
        Route::permanentRedirect('/products/10565107', '/');
        Route::permanentRedirect('/products/5808963', '/');
        Route::permanentRedirect('/houston-mission-bend/men', '/');
        Route::permanentRedirect('/product-category/chicken-wings', '/');
        Route::permanentRedirect('/wp-admin/admin-ajax.php', '/');
        Route::permanentRedirect('/public/menu/falooda', '/');
        Route::permanentRedirect('/public/menu/frankie', '/');
        Route::permanentRedirect('/public/menu/loaded-tender', '/');
        Route::permanentRedirect('/public/menu/ice-cream', '/');
        Route::permanentRedirect('/public/menu/drinks', '/');
        Route::permanentRedirect('/public/menu/extras', '/');
        Route::permanentRedirect('/public/menu/shawarma', '/');
        Route::permanentRedirect('/public/menu/shakes', '/');
        Route::permanentRedirect('/public/menu/chicken-wings', '/');
        Route::permanentRedirect('/public/menu/burger', '/');
        Route::permanentRedirect('/public/menu/loaded-fries', '/');
        Route::permanentRedirect('/menu/ice-cream-20', '/');
        Route::permanentRedirect('/product/cheese-lover', '/');
        Route::permanentRedirect('/menu/paratha-roll', '/');
        Route::permanentRedirect('/menu/ice-cream-a', '/');
        Route::permanentRedirect('/my-account/lost-password', '/');

         Route::post('/get-pizza-sizes', function (Request $request) {
            Session::put('selectedPizzaSize', $request->size);
            return response()->json([
                'sizes' => helper::customPizzaSize(), // Fetch sizes here if needed
            ]);
        })->name('get.pizza.sizes');
        ...
        Route::get('/check-timezone', function () {
            return response()->json([
                ...
                'UTC Time' => now()->setTimezone('UTC')->toDateTimeString(),
            ]);
        });
    ...
    Route::get('/payment-cancel/{order}', function ($orderId) {
        ...
        return redirect(url("/$location/cart"));
    })->name('payment.cancel');
    ...
    Route::get('/show-bogo-deal-item', [WebItemController::class, 'showBogoDealitem']);
    ...
    Route::get('/account-delete-policy', [WebOtherPagesController::class, 'accountDeletePolicy'])->name('account-delete-policy');
    Route::get('/privacy-policy', [WebOtherPagesController::class, 'privacypolicy'])->name('privacy-policy');


    Route::group(['prefix' => '{branch?}', 'where' => ['branch' => '(?!admin$)[a-zA-Z0-9-_]+'],'middleware' => ['SetUserLocation','RedirectLegacyUrls']], function () {
        Route::get('/', [HomeController::class, 'index'])->name('home')->middleware('clearCacheOnHome');
        Route::get('/direction', [HomeController::class, 'change_dir'])->name('change_dir');
        Route::get('/categories', [HomeController::class, 'categories'])->name('categories');
        Route::get('/catering', [WebBookingsController::class, 'index'])->name('catering');
        Route::get('blogs', [BlogController::class, 'blogs'])->name('userblogs');
        Route::get('blogs-{slug}', [BlogController::class, 'showblog'])->name('bblogdetails');

        // item
        Route::get('menu/{category}', [MenuController::class, 'index_con'])->name('menu');
        ...
        Route::get('/deals', [WebItemController::class, 'deals'])->name('deals');
        Route::get('/reward', [HomeController::class, 'rewards'])->name('reward');
