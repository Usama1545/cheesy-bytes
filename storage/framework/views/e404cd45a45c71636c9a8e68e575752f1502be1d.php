                    ...
                    <div class="card-body">
                        <div id="privacy-policy-three" class="privacy-policy">
                            <form action="<?php echo e(URL::to('admin/termscondition/update')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <textarea class="form-control" id="ckeditor" name="termscondition" required><?php echo e(@$gettermscondition->termscondition_content); ?></textarea>
