                                        ...
                                        <div class="card rounded-4 overflow-hidden h-100">
                                            <a href="<?php echo e(URL::to('item-' . $itemdata->slug)); ?>">
                                                <div class="card-image">
                                                    <img src="<?php echo e($itemdata['item_image']->image_url); ?>"
                                            ...
                                            <?php if($off > 0): ?>
                                                <div
                                                    ...
                                                    <h5><?php echo e($off); ?>% <?php echo e(trans('labels.off')); ?>

                                                    </h5>
                                                </div>
                                            <?php endif; ?>
                                            <div
                                                class="img-overlay <?php echo e(session()->get('direction') == '2' ? 'rtl' : ''); ?> set-fav-8">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <?php else: ?>
                                                        <button
                                                            ...
                                                            onclick="showitem('<?php echo e($itemdata->slug); ?>','<?php echo e(URL::to('/show-item')); ?>')"><?php echo e(trans('labels.add')); ?>

                                                            <i
                                                                class="fa-solid fa-plus addon_modal_icon_<?php echo e($itemdata->slug); ?>"></i>
                                                            <div
                                                                class="loader d-none addon_modal_loader_<?php echo e($itemdata->slug); ?>">
                                                            </div>
                                                        </button>
                                                    <?php endif; ?>
                                                </div>
