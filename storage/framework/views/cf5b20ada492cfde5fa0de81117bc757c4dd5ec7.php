        ...
        <?php if(!auth()->user()): ?>
            <div class="justify-content-center gap-2 d-flex  ">
                <div class="d-flex justify-content-center gap-2 mb-5 border border-radius  p-3">
                    <a href="<?php echo e(URL::to('/login')); ?>" class="btn btn-danger px-4">Sign In</a>
                    <span class="mt-2 text-muted">-or-</span>
                    <a href="<?php echo e(URL::to('/register')); ?>" class="btn btn-danger px-4">Join Now</a>
                </div>
            </div>
        <?php endif; ?>
        <!-- Rewards Options -->
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    <div class="card border p-3 rounded shadow-sm mb-5">
                        <img src="<?php echo e(asset('assets/images/default.png')); ?>" alt="default"/>
