...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <h3>Pizza Crusts</h3>
            <a href="crusts/add" class="btn btn-primary">Add New <i class="fa fa-plus"></i></a>
        </div>
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <div class="table-responsive" id="table-display">
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                <tbody>
                                <?php $i = 1; ?>
                                <?php $__currentLoopData = $crusts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap gap-1">
                                                <a class="btn btn-sm btn-info square" tooltip="<?php echo e(trans('labels.edit')); ?>"
                                                   href="<?php echo e(URL::to('admin/crusts-' . $item->id)); ?>"> <i class="fa-solid fa-pen-to-square"></i></a>
                                                <a class="btn btn-sm btn-danger square" tooltip="<?php echo e(trans('labels.delete')); ?>"
                                                   ...
                                                   <?php else: ?> onclick="Delete('<?php echo e($item->id); ?>','<?php echo e(URL::to('admin/crusts/delete')); ?>')" <?php endif; ?>>
