                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="<?php echo e(URL::to('admin/carrier/update-' . $catdata->id)); ?>" method="post"
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="category_name"
                                               placeholder="name"
                                               value="<?php echo e($catdata->name); ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                            ...
                                            <select name="branch_id" class="form-control selectpicker" required
                                                ...
                                                <?php $__currentLoopData = helper::get_branchs(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($branch->id); ?>"
                                                        <?php echo e($branch->id === $selected ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="link"
                                               placeholder="Link"
                                               value="<?php echo e($catdata->link); ?>" required>
                                    </div>
                                </div>
                                <div
                                    class="form-group <?php echo e(session()->get('direction') == '2' ? 'text-start' : 'text-end'); ?>">
                                    <a href="<?php echo e(URL::to('admin/carrier')); ?>"
