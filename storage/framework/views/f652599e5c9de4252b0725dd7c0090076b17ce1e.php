            ...
            <div class="col-12">
                <div class="card border-0 box-shadow">
                    <div class="card-body pb-0">
                        <form action="<?php echo e(URL::to('admin/topDeals/store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <a href="<?php echo e(URL::to('admin/topDeals/item')); ?>"
