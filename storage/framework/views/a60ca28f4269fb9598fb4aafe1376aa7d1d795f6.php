...
<ul class="navbar-nav">
    ...
    <ul class="collapse" id="deals">
        ...
        <li class="nav-item ps-4"
            id="7">
            <a class="nav-link rounded d-flex <?php echo e(request()->is('admin/category*') ? 'active' : ''); ?>"
               href="<?php echo e(URL::to('/admin/deals')); ?>" aria-expanded="false">
    ...
    <li class="nav-item mb-2 fs-7"
        id="11">
        <a class="nav-link rounded d-flex <?php echo e(request()->is('admin/carrier*') ? 'active' : ''); ?>"
           href="<?php echo e(URL::to('/admin/carrier')); ?>" aria-expanded="false">
