                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap gap-1">
                                                <a class="btn btn-sm btn-info square" tooltip="<?php echo e(trans('labels.edit')); ?>"
                                                   href="<?php echo e(URL::to('admin/sizes-' . $item->id)); ?>"> <i class="fa-solid fa-pen-to-square"></i></a>
                                                <a class="btn btn-sm btn-danger square" tooltip="<?php echo e(trans('labels.delete')); ?>"
                                                   onclick="Delete('<?php echo e($item->id); ?>','<?php echo e(URL::to('admin/sizes/delete')); ?>')" >
