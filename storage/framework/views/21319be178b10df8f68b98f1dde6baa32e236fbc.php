                        ...
                        <div
                            ...
                            <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:20px 0 0px 0">
                                <div bgcolor="#f8f4e8" align="left"
                                    ...
                                    class="m_-7788511936867687679padding-copy"><?php echo e(trans('labels.dear')); ?>

                                    <?php echo e($email); ?>,</div>
                                <div
                                    ...
                                    <div bgcolor="#f8f4e8" align="left"
                                        ...
                                        <?php echo e(trans('labels.your_verification_code_is')); ?> <b style="color: #fe724c;">
                                            <?php echo e($otp); ?></b><br> <?php echo e(trans('labels.kindly_verify_email')); ?></div>
                                    <div
...
<?php /**PATH C:\Users\Usama yasin\PhpstormProjects\foodefy-93nulled\codecanyon-28563040-single-restaurant-food-ordering-website-and-delivery-boy-app-with-admin-panel\foodefy\resources\views/email/emailverification.blade.php ENDPATH**/ ?>