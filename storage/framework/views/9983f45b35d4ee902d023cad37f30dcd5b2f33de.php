<table class="table table-striped table-bordered zero-configuration">
    ...
    <tbody id="tabledetails" data-url="<?php echo e(url('admin/promocode/reorder_promocode')); ?>">
        <?php $i = 1; ?>
        <?php $__currentLoopData = $getpromocode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promocode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="row1" data-id="<?php echo e($promocode->id); ?>">
                ...
                <td>
                    <?php echo e(helper::date_format($promocode->created_at)); ?> <br>
                    <?php echo e(helper::time_format($promocode->created_at)); ?>

                </td>
                <td>
                    <?php echo e(helper::date_format($promocode->updated_at)); ?> <br>
                    <?php echo e(helper::time_format($promocode->updated_at)); ?>

                </td>
                <td>
                    <div class="d-flex flex-wrap gap-1">
                        <a class="btn btn-sm btn-info square" tooltip="<?php echo e(trans('labels.edit')); ?>"
                            href="<?php echo e(URL::to('admin/promocode-' . $promocode->id)); ?>"><i
                                class="fa-solid fa-pen-to-square"></i></a>
                        <a class="btn btn-sm btn-danger square" tooltip="<?php echo e(trans('labels.delete')); ?>"
                            <?php if(env('Environment') == 'sendbox'): ?> onclick="myFunction()" <?php else: ?> onclick="DeleteData('<?php echo e($promocode->id); ?>','<?php echo e(URL::to('admin/promocode/delete')); ?>')" <?php endif; ?>><i
...
<?php /**PATH C:\Users\Usama yasin\PhpstormProjects\foodefy-93nulled\codecanyon-28563040-single-restaurant-food-ordering-website-and-delivery-boy-app-with-admin-panel\foodefy\resources\views/admin/promocode/promocodetable.blade.php ENDPATH**/ ?>