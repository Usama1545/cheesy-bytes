<table class="table table-striped table-bordered zero-configuration">
    ...
    <tbody id="tabledetails" data-url="<?php echo e(url('admin/carrier/reorder_category')); ?>">
        <?php $i = 1; ?>
                ...
                <td>
                    <div class="d-flex flex-wrap gap-1">
                        <a class="btn btn-sm btn-info square" tooltip="<?php echo e(trans('labels.edit')); ?>"
                            href="<?php echo e(URL::to('admin/carrier-' . $category->id)); ?>">
...
<?php /**PATH C:\Users\Usama yasin\PhpstormProjects\foodefy-93nulled\codecanyon-28563040-single-restaurant-food-ordering-website-and-delivery-boy-app-with-admin-panel\foodefy\resources\views/admin/carrier/categorytable.blade.php ENDPATH**/ ?>