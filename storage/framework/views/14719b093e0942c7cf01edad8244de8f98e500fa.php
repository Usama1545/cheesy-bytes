                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div id="privacy-policy-three" class="privacy-policy">
                            <form method="post" action="<?php echo e(URL::to('admin/topDeals/update')); ?>" name="about" id="about"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="offer_type" required="">
                                            ...
                                            <option value="1" <?php echo e($getitem->offer_type == 1 ? 'selected': ''); ?>>
                                                Fixed
                                            </option>
                                            <option value="2" <?php echo e($getitem->offer_type == 2 ? 'selected': ''); ?>>
                                                Percentage
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="form-label">Discount
                                            <span class="text-danger"> *</span></label>
                                        <input type="text" class="form-control numbers_only" name="offer_amount" value="<?php echo e($getitem->offer_amount); ?>"
                                               placeholder="Discount" required="">
                                    </div>


                                    <div class="form-group <?php echo e(session()->get('direction') == '2' ? 'text-start' : 'text-end'); ?>">
                                        <a href="<?php echo e(URL::to('admin/item')); ?>" class="btn btn-danger"><?php echo e(trans('labels.cancel')); ?></a>
