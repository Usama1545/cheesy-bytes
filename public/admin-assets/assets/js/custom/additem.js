...
function extras_fields(name, price) {
  ...
  divtest.innerHTML = '<div class="row mb-md-0 mb-2 variations"><div class="col-md-6"><div class="form-group"><input type="text" class="form-control" name="extras_name[]" placeholder="' +
    name + '" required></div></div><div class="col-md-5"><div class="form-group"><div class="d-flex gap-2"><input type="number" step="any" class="form-control" name="extras_price[]"  placeholder="' +
    price + '" required></div></div></div><div class="col-md-1"><button class="btn btn-danger btn-sm px-3" type="button" onclick="remove_extras_fields(' + extras_row + ');"><i class="fa fa-solid fa-trash"></i></button></div>';
...
function more_editextras_fields(name, price) {
  ...
  editdivtest.innerHTML =
    ...
    price +
    '" required><button class="btn btn-danger px-3" type="button" onclick="remove_editextras_fields(' +
    editroom +
